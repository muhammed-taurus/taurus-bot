...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [𝖙𝖆𝖚𝖗𝖚𝖘•𝖇𝖔𝖙] --*' + 
                                    '\n*𝖙𝖆𝖚𝖗𝖚𝖘•𝖇𝖔𝖙 an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [𝖙𝖆𝖚𝖗𝖚𝖘•𝖇𝖔𝖙] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
